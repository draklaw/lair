        ...
        def get_layer(layer_root):
            ...
            for child in layer_root:
                if child.tag == "properties":
                    ...
                    for n in tile_n:
                        gid = n & GID_MASK
                        hflip = bool(n & HFLIP_FLAG)
                        vflip = bool(n & VFLIP_FLAG)
                        dflip = bool(n & DFLIP_FLAG)
        ...
        def get_objectgroup(layer_root):
            ...
            for ogchild in layer_root:
                if ogchild.tag == "properties":
                    ...
                    ox = float(ogchild.attrib.get("x", 0))
                    oy = float(ogchild.attrib.get("y", 0))
                    owidth = float(ogchild.attrib.get("width", 0))
                    oheight = float(ogchild.attrib.get("height", 0))
                    ...
                    for ochild in ogchild:
                        if ochild.tag == "properties":
                            ...
                            ttext = ochild.text
                            tfontfamily = ochild.attrib.get("fontfamily", "sans-serif")
                            tpixelsize = int(ochild.attrib.get("pixelsize", 16))
                            twrap = bool(int(ochild.attrib.get("wrap", 1)))
                            tcolor = ochild.attrib.get("color", "#000000")
                            if tcolor:
                                tcolor = Color(tcolor)
                            ...
                            tkerning = bool(int(ochild.attrib.get("kerning", 1)))
                            thalign = ochild.attrib.get("halign", "left")
                            tvalign = ochild.attrib.get("valign", "top")
