...
//TEST(PropertyTest, TestJsonIO) {
////	typedef lair::BlendingMode Blend;

//	TestClass obj;
//	lair::JsonPropertySerializer serializer = lair::JsonPropertySerializer::createWithLairTypes();

//	int           count    = obj.getCount();
//	float         radius   = obj.getRadius();
//	lair::Vector4 pos      = obj.getPos();
//	std::string   name     = obj.getName();
////	Blend         blend    = obj.getBlendingMode();
////	unsigned      texFlags = obj.getTexFlags();
...
//	errors.clear();
//	ASSERT_TRUE(serializer.serialize(json, obj, TestClass::P_COUNT, &errors));
//	ASSERT_EQ(count, json.asInt());
//	ASSERT_EQ(0, errors.nErrors());

//	errors.clear();
//	ASSERT_TRUE(serializer.serialize(json, obj, TestClass::P_RADIUS, &errors));
//	ASSERT_EQ(radius, json.asFloat());
//	ASSERT_EQ(0, errors.nErrors());

//	errors.clear();
//	ASSERT_TRUE(serializer.serialize(json, obj, TestClass::P_POS, &errors));
//	ASSERT_TRUE(json.isArray());
//	ASSERT_EQ(4, json.size());
//	ASSERT_EQ(pos(0), json[0].asFloat());
//	ASSERT_EQ(pos(1), json[1].asFloat());
//	ASSERT_EQ(pos(2), json[2].asFloat());
//	ASSERT_EQ(pos(3), json[3].asFloat());
//	ASSERT_EQ(0, errors.nErrors());

//	errors.clear();
//	ASSERT_TRUE(serializer.serialize(json, obj, TestClass::P_NAME, &errors));
//	ASSERT_EQ(name, json.asString());
//	ASSERT_EQ(0, errors.nErrors());

////	errors.clear();
////	ASSERT_TRUE(serializer.serialize(json, obj, TestClass::P_BLEND, &errors));
////	ASSERT_EQ("none", json.asString());
////	ASSERT_EQ(0, errors.nErrors());

////	errors.clear();
////	ASSERT_TRUE(serializer.serialize(json, obj, TestClass::P_TEXFLAGS, &errors));
////	ASSERT_EQ("bilinear_mipmap | repeat", json.asString());
////	ASSERT_EQ(0, errors.nErrors());
...
//	pos      = lair::Vector4(-1265, 786, 888, 111);
//	name     = "aoeu";
////	blend    = lair::BLEND_MULTIPLY;
////	texFlags = lair::Texture::MIN_LINEAR | lair::Texture::MAG_NEAREST | lair::Texture::MIRROR;

//	errors.clear();
//	ASSERT_TRUE(serializer.deserialize(obj, TestClass::P_COUNT, Json::Value(count), &errors));
//	ASSERT_EQ(count, obj.getCount());
//	ASSERT_EQ(0, errors.nErrors());

//	errors.clear();
//	ASSERT_TRUE(serializer.deserialize(obj, TestClass::P_RADIUS, Json::Value(radius), &errors));
//	ASSERT_EQ(radius, obj.getRadius());
//	ASSERT_EQ(0, errors.nErrors());

//	Json::Value jsonPos(Json::arrayValue);
//	jsonPos.append(pos(0));
//	jsonPos.append(pos(1));
//	jsonPos.append(pos(2));
//	jsonPos.append(pos(3));
//	errors.clear();
//	ASSERT_TRUE(serializer.deserialize(obj, TestClass::P_POS, jsonPos, &errors));
//	ASSERT_EQ(pos, obj.getPos());
//	ASSERT_EQ(0, errors.nErrors());

//	errors.clear();
//	ASSERT_TRUE(serializer.deserialize(obj, TestClass::P_NAME, Json::Value(name), &errors));
//	ASSERT_EQ(name, obj.getName());
//	ASSERT_EQ(0, errors.nErrors());

////	errors.clear();
////	ASSERT_TRUE(serializer.deserialize(obj, TestClass::P_BLEND, Json::Value("multiply"), &errors));
////	ASSERT_EQ(blend, obj.getBlendingMode());
////	ASSERT_EQ(0, errors.nErrors());

////	errors.clear();
////	ASSERT_TRUE(serializer.deserialize(obj, TestClass::P_TEXFLAGS, Json::Value("min_linear | mag_nearest | mirror"), &errors));
////	ASSERT_EQ(texFlags, obj.getTexFlags());
////	ASSERT_EQ(0, errors.nErrors());
//}
